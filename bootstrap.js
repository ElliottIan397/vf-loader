  ...
  effect: async ({ trace }) => {
    ...
    const payload =
      ...
      {};
        ...
        typeof window.DigitolGoogleSearchModel.update === "function"
      ) {
        window.DigitolGoogleSearchModel.update(payload);
      } else {
        console.warn("📊 No active Digitol model module available");
      }
  },
});
